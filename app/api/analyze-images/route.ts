...
export async function POST(request: NextRequest) {
  try {
    ...
    const prompt = `
You are an expert LinkedIn profile analyzer and career strategist with deep expertise in talent acquisition, personal branding, and career development. I need you to perform an extremely thorough, comprehensive analysis of these LinkedIn profile screenshots.

CRITICAL INSTRUCTIONS:
1. Analyze EVERY SINGLE DETAIL visible in the screenshots with meticulous attention
2. Extract ALL information from EVERY section of the LinkedIn profile shown
3. Analyze the visual presentation, formatting, structure, and professional impact
...
1. **HEADER/CONTACT SECTION ANALYSIS:**
   ...
   - Analyze profile photo presence and professionalism (if visible)
...
8. **VISUAL PRESENTATION ANALYSIS:**
   - Evaluate overall visual appeal and professional presentation
   - Analyze formatting consistency and readability
   - Assess use of multimedia elements (if any)
   - Review section organization and information hierarchy
...

{
  "profileData": {
    "personalInfo": {
      "fullName": "Complete name as visible",
...
`;
    ...
    // Convert images to base64 and prepare for Gemini
    const imageParts = [];
    ...
    const errorMessage = error instanceof Error 
      ? error.message 
      : 'Failed to analyze images. Please ensure the images contain readable LinkedIn profile content.';
