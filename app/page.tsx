            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 shadow-2xl">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="ml-4 text-gray-400 text-sm">SkillSight Analysis</span>
                </div>
      ...
      <section id="testimonials" className="relative z-10 px-6 py-32 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Join thousands of professionals who&apos;ve transformed their careers with SkillSight
            </p>
          </div>
      ...
      <footer className="relative z-10 px-6 py-16 bg-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
                          <p>&copy; 2024 SkillSight. All rights reserved. Built with AI for professionals.</p>
          </div>
        </div>
      </footer>
